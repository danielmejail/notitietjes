\theoremstyle{plain}
\newtheorem{teoIntroSes}{\teoname}[section]

\theoremstyle{definition}
\newtheorem{defIntroSes}[teoIntroSes]{\defname}
...
\begin{defIntroSes}\label{def:sesquilineales:pairing}
...
\begin{teoIntroSes}\label{teo:sesquilineales:perpendicular}
